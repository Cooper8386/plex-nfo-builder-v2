...
Node 24 / TypeScript rebuild tracked in [issue #1](https://github.com/Cooper8386/plex-nfo-builder-v2/issues/1), based on `REPO_SPEC.md`. Version 0.17.0 implements milestone 1 phases 1–17. This is a foundation, not a feature-complete media manager.
